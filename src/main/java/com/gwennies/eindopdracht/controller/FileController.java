...
import com.gwennies.eindopdracht.payload.response.FileResponse;
import com.gwennies.eindopdracht.payload.response.MessageResponse;
import com.gwennies.eindopdracht.service.FileStorageService;
...
public class FileController {
    ...
    @GetMapping("/files")
    public ResponseEntity<List<FileResponse>> getFilesgetListFiles() {
